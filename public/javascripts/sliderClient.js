...
function readImage(el) {
    ...
    $('.imageReader .params a').attr('href', `/downloadShare?&type=file&file=${el}`);
...
$('.imageReader .left-slide').on('click', function () {
    ...
    $('.imageReader .params a').attr('href', `/downloadShare?type=file&file=${ImageTab[presentIndex-1]}`);
...
function videoReader(el) {
    ...
    $('.videoReader').html(`<div class="params">
        <a href="/downloadShare?type=file&file=${el}"><i class="fas fa-file-download"></i></a>
