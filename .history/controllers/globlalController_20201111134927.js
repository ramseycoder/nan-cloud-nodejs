...
exports.shareFile = async (req, res) => {
    ...
    if (SO.etat) {
        ...
        console.log('headers', range, (req.headers['sec-fetch-mode'] === undefined || req.headers['sec-fetch-site'] === undefined),);
        if (!range || (range && ((req.headers['sec-fetch-mode'] === undefined || req.headers['sec-fetch-site'] === undefined) || (req.headers['sec-fetch-mode'] !== undefined && req.headers['sec-fetch-mode'] === "navigation") || (req.headers['sec-fetch-site'] !== undefined && req.headers['sec-fetch-site'] === "none")))) {
            console.log('oui not found');
