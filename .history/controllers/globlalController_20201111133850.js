...
exports.shareFile = async (req, res) => {
    ...
    if (SO.etat) {
        ...
        if (!range && req.headers['sec-fetch-mode'] !== undefined && req.headers['sec-fetch-site'] !== undefined && (req.headers['sec-fetch-mode'] === "navigate" || req.headers['sec-fetch-site'] === "none")) {
