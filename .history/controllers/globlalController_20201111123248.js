...
exports.shareFile = async (req, res) => {
    ...
    if (SO.etat) {
        ...
        let fetchmode = req.headers['sec-fetch-mode'];
        const range = req.headers.range;
        console.log('headers', req.headers);
        if (req.headers['sec-fetch-mode'] === "navigate" || req.headers['sec-fetch-site'] === "none") {
            ...
            res.status(200);
            createReadStream(video, { 393216, end }).pipe(res);
        }
    }
};
